  ...
  describe('mapSTateToProps', () => {
    it('should map the article to the props', () => {
      const dummyState = {
        ...
        profile: { userProfile: { username: 'mockUsername' } },
        deleteArticleReducer: { success: false },
      };
      ...
      chai.expect(props.currentUsername)
        .to.equal(dummyState.profile.userProfile.username);
      chai.expect(props.deleted)
        .to.equal(dummyState.deleteArticleReducer.success);
    });
  });
