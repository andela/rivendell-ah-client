  ...
  describe('Testing mapStateToProps', () => {
    it('should map the state to the props correctly', () => {
      ...
      expect(componentState).toEqual({
        featArticlesErrors: state.articles.errors,
        featArticlesLimit: state.articles.limit,
        featArticlesActivePage: state.articles.activePage,
        feetArticlesPageCount: Math
          .ceil(state.articles.articlesCount / state.articles.limit),
        featArticlesCount: state.articles.articlesCount,
        featuredArticles: state.articles.articles,
        featArticlesIsLoading: state.articles.isLoading,
