...
export const NoContent = ({ message, iconSize }) => (
  <div className="no-content">
    <i
      className="material-icons no-content-icon"
  ...
  <div className="favorite-articles-container">
    <h3>Favorite articles</h3>
    {
      favoriteArticles.length ? (
        ...
        <NoContent
          message="You currently have on favorite articles"
          iconSize="1000%"
        />
      )
    }
    ...
    <div id="pagination-container">
      <Pagination
        ...
        totalPages={
          ...
          && token ? feedPageCount : feetArticlesPageCount
        }
      />
    </div>
  </div>
