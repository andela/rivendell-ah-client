...
EditArticle.propTypes = {
  ...
  storeState: propTypes.objectOf(propTypes.object),
};
...
export const mapDispatchToProps = dispatch => ({
  updateArticle: (article, slug) => dispatch(
    updateArticleAction(article, slug)
  ),
  loadArticle: slug => dispatch(loadArticleAction(slug)),
});

export const mapStateToProps = state => ({
  storeState: state.updateArticleReducer,
});

export default connect(mapStateToProps,
  mapDispatchToProps)(EditArticle);
