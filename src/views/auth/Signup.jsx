  ...
  */
  ...
  updateFormInputErrs = (formInputErrors, formInput) => {
    ...
    if (formInput.name === 'firstName' && formInput.value.length >= 2) {
      index = formInputErrors
        .indexOf('First name entered should have minimum of 2 characters');
      if (index > -1) formInputErrors.splice(index, 1);
    }
    // remove the 'is required' error, on input field change
    if (formInput.name === 'lastName' && formInput.value.length >= 2) {
      index = formInputErrors
        .indexOf('Last name entered should have minimum of 2 characters');
      if (index > -1) formInputErrors.splice(index, 1);
    }
    ...
    if (formInput.name === 'password'
      ...
      index = formInputErrors
        .indexOf('Your password must include an uppercase, '
    ...
    if (formInput.name === 'confirm' && formInput.value === password) {
      index = formInputErrors
        .indexOf('Confirm password does not match');
      if (index > -1) formInputErrors.splice(index, 1);
    }
  ...
  validate = ({ firstName, lastName, email, username, password, confirm }) => {
    ...
    if (firstName.length < 2) {
      errors.firstName
        .push('First name entered should have minimum of 2 characters');
      errors.errorCount += 1;
    }
    if (!lastName) {
    ...
    if (lastName.length < 2) {
      errors.lastName
        .push('Last name entered should have minimum of 2 characters');
      errors.errorCount += 1;
    }
    if (!username) {
